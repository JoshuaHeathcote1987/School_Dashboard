                ...
                <table id="user_table" class="table table-striped">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col">user_id_sender</th>
                    ...
                    <tbody>
                        ...
                        @foreach($data['messages'] as $i => $datum)
                            <tr>
                                ...
                                <td>{{$datum->head}}</td>
                                <td>{{ substr($datum->body, 0, 30) }}...</td>
                                <td>{{$datum->created_at}}</td>
                                <td>
                                    <div class="float-right">
                                        <button class="btn btn-info" data-toggle="modal" data-target="#messageShowModal{{$i}}"><i class="fas fa-eye"></i></button>
                                        <button class="btn btn-warning" data-toggle="modal" data-target="#messageUpdateModal{{$i}}"><i class="fas fa-pen-square"></i></button>
                                        <form class="d-inline" action="{{route('message.destroy', $datum)}}" method="POST">
                                            @csrf 
                                            @method('DELETE')
                            ...
                            {{-- User Functionality --}}
                            <x-dashboard.message.update :message="$datum" :i="$i" />
                            <x-dashboard.message.show :message="$datum" :i="$i" />
                        @endforeach
                    </tbody>
                </table>
            </div>
